  ...
  return (
    ...
    >
      <div className="py-2 flex-1 flex flex-col items-start justify-center gap-6">
        ...
        Craving a delicious meal? Our food delivery app brings a world of flavors to your doorstep. 
         Browse diverse menus, from sizzling stir-fries to mouthwatering desserts.With a few taps,
         satisfy your hunger and let us handle the rest. 
